...
class GeneralListAdapter() : RecyclerView.Adapter<GeneralListAdapter.MovieListHolder>() {
    ...
    var movieList : ArrayList<String> = arrayListOf()
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): GeneralListAdapter.MovieListHolder = MovieListHolder(LayoutInflater.from(parent.context).inflate(R.layout.movie_list_item_layout, parent,false))
